...
export const Navbar = ({ fixed }) => {
    ...
    return (
        <>
            <nav class="relative flex flex-wrap items-center justify-between px-4 bg-white container mx-auto">
                <div class="container mx-auto flex flex-wrap items-center justify-between">
                    ...
                    <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
                        <a
                            ...
                            href="/"
                        >
                            <img src="logo_black.svg" alt="logo" class=" h-14 w-36 p-2 -ml-3" />
                        </a>
                        <button
                    ...
                    <div
                        ...
                        id="navbar"
                    >
                        <ul class="flex flex-col lg:flex-row lg:flex-grow-0 lg:mt-0 list-none lg:ml-auto text-base flex-grow mt-8">
