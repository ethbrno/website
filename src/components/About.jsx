                ...
                <div
                    ...
                    <div class="flex justify-center">
                        <a href="https://join.ethbrno.cz/"
                            class="inline-flex text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-black  text-lg">Apply
                            To Hack</a>
                        <a href="https://ethbrno.cz/sponsor-deck.pdf" target="_blank" rel="noopener noreferrer"
                            class="ml-4 inline-flex text-black bg-white border-0 py-2 px-6 focus:outline-none hover:bg-gray-200  text-lg underline">Sponsor</a>
                    </div>
                </div>
